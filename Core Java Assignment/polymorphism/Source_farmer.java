...
class Farmer {
	...
	void farmOperations() {
		System.out.println("General farming operations.");
	}
}
...
class DairyFarmer extends Farmer {
	...
	// farmOperations
	void farmOperations() {
		System.out.println("Milking cows, feeding cattle, milk storage.");
	}
}
...
class PoultryFarmer extends Farmer {
	...
	void farmOperations() {
		System.out.println("Feeding chickens, egg collection, poultry care.");
	}
}
...
class organicFarmer extends Farmer {
	...
	void farmOperations() {
		System.out.println("Using natural fertilizers, no chemicals.");
	}
