...
class defance {
	...
	defance(){
		...
		this.defenceId = 101;
		this.nameofHead = "Pratik";
		this.noOfTroops = 10;
		this.budget = 5000;
		this.noOfDept = 10 ;
		this.noOfVehicle = 50000;
		this.locationOfHeadcouter = "Shevgaon";
...
class Army extends defance{
	...
	// Attack 
		void Attack() {
			System.out.println("Army Attack starting..!");
		}
...
class navy extends defance{
	...
	// Attack 
		void Attack() {
			System.out.println("Navy Attack starting..!");
		}
...
class AirForce extends defance{
	...
	// Attack 
		void Attack() {
			System.out.println("Airforce Attack starting..!");
		}
