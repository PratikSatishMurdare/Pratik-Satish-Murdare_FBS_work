...
void main()
{
	...
	while(1){
		...
		case 8 :
			free(arr);
			printf("----- Thank you, for using the Player Management System. Created by (Pratik Murdare) -----\n\n");
			exit(0);
			break;
		default :
...
void displayplayerbyrunorwicket(player* arr,int nsize)
{
	...
	printf(" 1) Top 3 Runner Enter 1 :  | 2) Top 3 Wicketer Enter 2:  |  3) Lowest 3 wicket Enter 3 :  |  4) Lowest 3 Runer Enter 4 :    \n\n5) Enter for Exit 5: \n");
	printf("===>: ");
	scanf("%d",&choice);
